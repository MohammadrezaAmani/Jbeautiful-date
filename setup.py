...
NAME = 'jbeautiful-date'
DESCRIPTION = 'Simple and beautiful way to create jalali date and datetime objects in Python.'
URL = 'https://github.com/MohammadrezaAmani/Jbeautiful-date'
